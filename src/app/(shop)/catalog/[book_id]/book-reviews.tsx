...
import { createBookReview, deleteBookReview } from "./actions";
...
function BookReviewForm({ book }: { book: Book }) {
  ...
  return (
    <form className="flex flex-col gap-2" action={createBookReview}>
      <textarea
...
export function BookReviewSection({ book }: { book: Book }) {
  return (
